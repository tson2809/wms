 ...
 * @author hung
 */
@WebServlet(name="InventorySheetViewController", urlPatterns={"/inventory-sheet-view"})
public class InventorySheetViewController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InventorySheetViewController</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InventorySheetViewController at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
