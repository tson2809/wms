...
<html>
    ...
    <body>
            ...
            <div class="content">
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-9">
                            <c:if test="${sessionScope.user.role.roleId == 3 and !readOnly}">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="productTable">
                                        ...
                                        <tbody id="productTableBody">
                                            <tr>
                                                <td colspan="${(sessionScope.user.role.roleId == 3 and !readOnly) ? '7' : '6'}" class="text-center text-muted">
                            ...
                            <div class="bg-light rounded p-4">
                                <form id="receiptForm" method="post" action="${pageContext.request.contextPath}/goods-receipt-edit">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" name="receiptDate" id="receiptDate" value="${formattedDate}" ${(sessionScope.user.role.roleId == 2 or readOnly) ? 'readonly' : ''} required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="receiptCode" placeholder="Nhập mã phiếu (VD: PN001)" value="${receipt.receiptCode}" ${(sessionScope.user.role.roleId == 2 or readOnly) ? 'readonly' : ''}>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control" name="notes" rows="4" placeholder="Nhập ghi chú..." ${(sessionScope.user.role.roleId == 2 or readOnly) ? 'readonly' : ''}>${receipt.notes}</textarea>
                                    </div>
        ...
        <script src="${pageContext.request.contextPath}/js/goods-receipt-edit.js"></script>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="serialModalTitle">
                            <c:choose>
                                <c:when test="${sessionScope.user.role.roleId == 2 or readOnly}">Xem Serial Number</c:when>
