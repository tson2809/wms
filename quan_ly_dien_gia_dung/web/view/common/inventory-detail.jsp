<%-- Document : inventory-detail Created on : Mar 4, 2026, 10:28:03 PM Author : GIAKHANHPC --%>
                                        ...
                                        <div class="inventory-card p-4">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 text-center">
                                                    <img width="250" class="img-fluid rounded"
                                                                        ...
                                                                        <td>
                                                                            <c:choose>
                                                                                <c:when test="${s[1]=='in_stock'}">
                                                                                    <span class="badge bg-success">Trong
                                                                                        kho</span>
                                                                                </c:when>
                                                                                ...
                                                                                <c:when test="${s[1]=='defective'}">
                                                                                    <span
                                                                                        class="badge bg-danger">Lỗi</span>
                                                                                </c:when>
                                                                                <c:when test="${s[1]=='returned'}">
                                                                                    <span
                                                                                        class="badge bg-warning text-dark">Trả
                                                                                        hàng</span>
                                                                                </c:when>
                                                                                <c:otherwise>
                                                                                    <span
                                                                                        class="badge bg-secondary">${s[1]}</span>
                                                                                </c:otherwise>
                                                                            </c:choose>
                                                                        </td>
                                                                        <td>${s[2]}</td>
                                            ...
                                            <div class="pagination-wrapper mt-4">
                                                <div class="pagination-controls">
                                                    ...
                                                    <a class="page-btn ${currentPage == 1 ? 'disabled' : ''}"
                                                       href="${pageContext.request.contextPath}/inventory-detail?page=${currentPage - 1}${queryParams}">
                                                        ‹
                                                    </a>
                                                    <span class="page-jump-form">
                                                        Page
                                                        <form action="${pageContext.request.contextPath}/inventory-detail"
                                                              method="get"
