            ...
            <div class="sidebar pe-6 pb-5">
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="/quan_ly_dien_gia_dung/category-list" class="nav-item nav-link"><i class="fa fa-box me-2"></i>Danh mục</a>
                        <a href="/quan_ly_dien_gia_dung/brand-list" class="nav-item nav-link"><i class="fa fa-box me-2"></i>Thương hiệu</a>
                    </div>
                </nav>
            </div>
            <!-- Sidebar End -->