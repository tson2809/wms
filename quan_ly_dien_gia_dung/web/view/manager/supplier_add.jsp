<%-- 
    ...
    Created on : 31 thg 1, 2026, 11:28:10
    Author     : thais
--%>
            ...
            <div class="content">
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="mb-3">
                                <h5 class="mb-0 fw-semibold">Thêm nhà cung cấp</h5>
                            </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="supplierName" name="supplierName"
                                                   value="${supplierName}" placeholder="Nhập tên nhà cung cấp">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="contactPerson" name="contactPerson"
                                                   value="${contactPerson}" placeholder="Họ tên người liên hệ">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="email" name="email"
                                                   value="${email}" placeholder="email@gmail.com">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" id="description" name="description" rows="3"
                                                      placeholder="Mô tả về nhà cung cấp">${description}</textarea>
